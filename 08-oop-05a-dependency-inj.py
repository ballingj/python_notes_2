##############################################
# Dependency Injection - separated the reporing function into it's own module and introduced 
# a dependency problem that is solved by dependency injection using __init__ method (dunder init)
...
#############################################################
# reporting.py
# we are separating the reporting into it's own module
# here is where we used the __init__ method to inject dependency data
