...
# we are refactoring again to incorporate the get_full_name method - this solves the problem of having to change
# the order of first name last name (duplicate code) - now that order can be changed in only one location
